---
title: "POST /api/dids"
description: "Registers a new on-chain DID after the identifier (email or phone) has been verified, binding the passkey credential to the decentralized identifier."
---
