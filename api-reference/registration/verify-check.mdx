...
description: "Verifies a one-time passcode against the user's identifier and returns a signed attestation that the registration endpoint accepts as proof of ownership."
---
