...
description: "Checks whether an email or phone identifier is available for registration, validating reserved lists, duplicates, and per-IP registration limits."
---
