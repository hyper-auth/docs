...
description: "Creates a registration session for an identifier after enforcing reserved-name, duplicate-DID, and per-IP rate-limit checks against the D1 database."
---
