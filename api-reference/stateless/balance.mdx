...
description: "Returns the native ETH or ERC-20 USDC balance for any address on a supported chain, useful for displaying wallet balances inside HyperAuth-powered apps."
---
