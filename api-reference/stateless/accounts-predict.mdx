...
description: "Predicts the counterfactual ERC-4337 smart account address for a given P-256 passkey public key and CREATE2 salt without deploying the contract."
---
