...
<CardGroup cols={2}>
  ...
  <Card title="Email code" icon="envelope" href="/api-reference/email-code/start">
    Public email-code challenge endpoints that back the widget's sign-in flow.
  </Card>
  <Card title="Console (Admin API)" icon="shield-halved" href="/api-reference/console/overview">
    UCAN-gated `/v1/console/*` routes for managing apps, users, credentials, sessions, API keys, webhooks, policies, and audit events.
  </Card>
</CardGroup>
