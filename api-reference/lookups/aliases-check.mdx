...
description: "Checks whether a handle alias is available before claiming it during HyperAuth registration, returning availability and the canonical alias hash."
---
