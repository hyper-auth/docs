...
description: Reference for ClientConfig, ContractsConfig, WorkerConfig, and the other configuration objects accepted by the HyperAuth SDK client at initialization time.
---
