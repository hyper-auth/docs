...
description: Complete API reference for the HyperAuth SDK client — all exports, types, configuration options, and methods exposed by the @hyperauth/client package.
---
