...
description: Reference for all TypeScript types exported from the HyperAuth SDK package @hyperauth/client, covering configuration, registration, vault, and payment types.
---
