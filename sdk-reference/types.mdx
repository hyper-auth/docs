...
description: Reference for every TypeScript type exported from the @hyperauth/sdk (@hyperauth/client) package, including config, DID, vault, and UserOperation interfaces.
---
