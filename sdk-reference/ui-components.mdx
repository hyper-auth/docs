...
description: Reference for the HyperAuth React UI components — login button, registration modal, passkey prompt, and vault status indicators with className overrides.
---
