...
description: Reference for HyperAuth React UI components — registration, sign-in, and vault widgets — including props and the className overrides each component accepts.
---
