...
description: API reference for the @hyperauth/react package — HyperAuthProvider, useHyperAuth, useRegistration hooks, and the CSP manifest helpers for Next.js and Vite.
---
