...
Returns `cspManifest` serialized as a single CSP header value. Use this when your CSP is composed at request time, for example from a Next.js proxy or middleware.
