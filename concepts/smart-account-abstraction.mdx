...
description: Why ERC-4337 account abstraction is core to HyperAuth, how HyperAuthFactory and CREATE2 make addresses deterministic, and how passkey sigs verify on-chain.
---
