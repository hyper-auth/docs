...
description: How HyperAuth's dual-worker architecture splits the stateless signer from the stateful vault, persists to OPFS, and runs cryptography inside SQLite.
---
