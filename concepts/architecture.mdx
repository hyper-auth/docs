...
description: Why HyperAuth is built the way it is — the dual-worker model, the split between stateless signer and stateful vault, OPFS persistence without SharedArrayBuffer, and the decision to run cryptography inside SQLite.
---
