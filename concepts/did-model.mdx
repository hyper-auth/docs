...
description: What DIDs are, why they matter for self-sovereign identity, and how HyperAuth generates them in the signer worker and registers them on-chain via DIDRegistry.
---
