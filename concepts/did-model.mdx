...
description: What DIDs are, why they matter for self-sovereign identity, and how HyperAuth implements them — from generation in the signer worker to on-chain registration in the DIDRegistry contract.
---
