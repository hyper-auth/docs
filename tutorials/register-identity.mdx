...
description: "Build a complete passkey identity registration flow with React using the useRegistration hook and its twelve progress phases from session to on-chain DID."
icon: "user-plus"
---
