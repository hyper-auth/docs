...
description: "Build a complete passkey-based identity registration flow with the useRegistration React hook, surfacing each of the twelve registration progress phases."
icon: "user-plus"
---
