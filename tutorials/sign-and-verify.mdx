...
description: "Sign arbitrary data with your HyperAuth passkey identity, verify signatures off-chain, and derive a deterministic blockchain address from the same key."
icon: "signature"
---
