...
description: "Run a HyperAuth client app, the Vault Worker, and the WASM signer enclave together on your laptop with hot reload, mock OTP delivery, and local D1."
icon: "terminal"
---
