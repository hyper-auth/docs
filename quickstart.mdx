---
title: "Quickstart"
description: "Go from zero to a working passkey-authenticated React app in under ten minutes — install the SDK, mount the provider, and register your first identity."
icon: "rocket"
---
