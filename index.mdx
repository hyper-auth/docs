---
title: "Introduction"
description: "A decentralized identity platform using passkey-secured WASM enclaves. No passwords. No custody. No compromise."
icon: "circle-info"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Decentralized identifiers" icon="id-card">
    W3C DIDs anchored to the user's passkey keypair.
  </Card>
  ...
  <Card title="UCAN authorization" icon="key">
    Capability-based delegation without a central authority.
  </Card>
