...
description: "Create and authenticate WebAuthn passkeys with the HyperAuth SDK, handle common authentication errors, and configure auto-lock timeouts for the vault."
icon: "fingerprint"
---
