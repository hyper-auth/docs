...
description: "Wire HyperAuthProvider into a Next.js App Router app, mount it on the client, emit the SDK's required Content Security Policy, and set runtime env vars."
icon: "react"
---
...
Use this guide if you build with Next.js 14 or later on the App Router. If you use Vite or another bundler, the [Quickstart](/quickstart) covers the simpler setup path.
