---
title: "Device Sync"
description: "Transfer an existing HyperAuth passkey identity to a new device using the three-step encrypted sync protocol, including QR pairing and recovery codes."
icon: "arrows-rotate"
---
