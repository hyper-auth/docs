---
title: "Alias Lookup"
description: "Compute alias hashes, resolve handles and DIDs through the HyperAuth indexer, and check alias availability before letting users claim a new identifier."
