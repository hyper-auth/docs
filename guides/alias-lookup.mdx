---
title: "Alias Lookup"
description: "Compute alias hashes with keccak256, resolve aliases and DIDs through the indexer, and check handle availability before completing HyperAuth registration."
