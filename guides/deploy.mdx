---
title: "Deploy"
description: "Deploy the HyperAuth Vault Worker and a client app that consumes the SDK to Cloudflare Workers, including secrets, D1 bindings, and custom domain setup."
icon: "cloud-arrow-up"
---
