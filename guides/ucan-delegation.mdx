...
description: "Mint UCAN tokens with HyperAuth, delegate scoped capabilities to other identities, and invoke delegated commands across devices and third-party agents."
icon: "key"
---
