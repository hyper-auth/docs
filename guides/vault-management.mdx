...
description: "Lock, unlock, and inspect HyperAuth vault status, export and import encrypted vault backups, and persist vault state across sessions with OPFS snapshots."
icon: "vault"
---
