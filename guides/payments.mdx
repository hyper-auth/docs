---
title: "Payments"
description: "Submit gasless ERC-4337 payments from a HyperAuth smart account using the SDK's built-in payment methods, paymaster sponsorship, and UserOperation helpers."
icon: "credit-card"
---
