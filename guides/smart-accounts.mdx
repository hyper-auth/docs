...
description: "Predict counterfactual smart account addresses, inspect on-chain state, build and send ERC-4337 UserOperations, and await transaction receipts with the SDK."
icon: "wallet"
---
