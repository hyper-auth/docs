...
description: "Predict smart account addresses, inspect on-chain state, build and send ERC-4337 UserOperations, and wait for receipts using the HyperAuth SDK."
icon: "wallet"
---
